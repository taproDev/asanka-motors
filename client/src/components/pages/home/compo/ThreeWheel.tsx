...
export const HomePageThreeWheel = () => {
  return (
    <div className="">
        <div className="col-12 my-5">

            <div className="my-5 home-page-3wheel-section">
                <h1 className="text-dark" data-aos="fade-down" data-aos-duration="800" data-aos-delay="100" data-aos-once="true">ThreeWheeI Spareparts</h1>
                <p className="sub-text" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100" data-aos-once="true">Welcome to our Latest Product Section, where innovation and excellence meet to bring you the cutting-edge solutions <br/> you've been waiting

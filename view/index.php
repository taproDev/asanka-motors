...
<div class="container">
    ...
    <!-- about us (short) -->
    <div id="aboutUs" class="col-12 d-flex flex-column flex-lg-column justify-content-between mx-auto my-5 shadow-lg border-0 rounded p-4">
        <div class="row ">
            <!-- item 1 -->
    ...
    <!-- image silder sm -->
    <div class="col-12 mx-0 w-100 my-5 d-block d-md-none">
        <div class="row" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100" data-aos-once="true">
            <div id="carouselExampleAutoplaying" class="carousel slide p-0" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
...
<div class="container">
    ...
    <div class="col-12" id="contactUs">
        <div class="row">
            ...
            <div class="text-center col-12  p-3 bg-darker  ps-5 text-uppercase fw-bold mt-5 ff-alumini" data-aos="flip-right" data-aos-duration="800" data-aos-delay="200" data-aos-once="true">
            ...
            <div class="col-11 mt-3 pt-5 mb-5">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5 p-5 contact-bg">
                        <span class="section-title" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100" data-aos-once="true">CONTACT US</span><br>
                        <p class="dis-para text-dark" data-aos="fade-right" data-aos-duration="800" data-aos-delay="300" data-aos-once="true">We're always here to assist you with any questions or concerns you may have. Whether you need help choosing the right product, tracking your order, or anything else, we're just a phone call or email away.
                            <br><br>

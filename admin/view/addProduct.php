                ...
                ?>
                    <div  id="updateBtnSection">
                        <div class="col-12 mt-4">
                            <button class="btn btn-danger rounded-0 py-3 col-12 " onclick="updateProduct('<?php echo $id ?>');">Update Product</button>
                        </div>

                        <div class="col-12 mt-4">
                            <p>if you delete this you cannot recovery</p>
                            <button class="btn btn-danger rounded-0 py-3 col-12 " onclick="deleteProduct('<?php echo $id ?>');">Delete Product</button>
                        </div>
                    </div>
                <?php
                } else {
                ?>
                    <div class="col-12 mt-4" id="addBtnSection">
                        <button class="btn btn-danger rounded-0 py-3 col-12" onclick="addProduct();" id="add_btn">Add Product</button>
    ...
    ?>
        <script>
            window.onload = function() {
                setProduct_for_update('<?php echo $id ?>');
            };
        </script>

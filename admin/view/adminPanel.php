        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 p-4 bg-danger ">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 h5 text-white">
                                <?php
                               //$product_rs = Database::search("SELECT * FROM `helmet` ");
                    ...
                    <div class="col-12 col-lg-4 p-4 bg-primary ">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 h5 text-white">
                                <?php
                                //$product_rs = Database::search("SELECT * FROM `tyre` ");
                                //echo ($product_rs->num_rows . " Products");
                                ?>50
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 p-4 bg-warning ">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 h5 text-white">
                                <?php
                               //$feed_rs = Database::search("SELECT * FROM `happycustomer` ");
                               //echo ($feed_rs->num_rows . " Users");
                                ?>50
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-lg-4 mt-3 p-4 bg-white">
                <div class="row">
                    ...
                    <a href="./addHappyCustomer.php" class="btn-dark btn py-2 col-12 mt-2 text-white">Add Happy customer</a>
                    <a href="./additional.php" class="btn-dark btn py-2 col-12 mt-2 text-white">Additional</a>
